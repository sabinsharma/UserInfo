<div class="row" id=user_form_row>
   <div id="form_container" class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div id="form_wrapper" >
            {{--Form starts here--}}
            {!! Form::open(['url' => 'user/update','id'=>'frmUpdateUser','novalidate']) !!}
                ...
                <div class="form-group" id="clientError">
                    ...
                    {{Form::hidden('user_id',$user->id,['class'=>'form-control','id'=>'userid'])}}
                </div>
                ...
                <div class="form-group" id="provinceError">
                    ...
                    <div id="div_select" tabindex="2">
                        {{Form::text('province_text',$user->province->name,['class'=>'form-control','id'=>'prov_text','disabled'])}}{{--Display the selected province--}}
                        ...
                        {{form::hidden('prov_id',$user->prov_id,['class'=>'form-control','id'=>'_province'])}} {{--holds the id of selected province--}}
                    </div>
                </div>
                {{--End of Dropdown--}}
                ...
                <div class="form-row">
                    <div class="col" id="telError">{{--text box for telephone--}}
                        ...
                        {{Form::text('telephone',$user->telephone,['class'=>'form-control','tabindex'=>'3'])}}
                    </div>
                ...
                <div class="form-group" id="salaryError">
                    ...
                    {{Form::text('salary',$user->salary,['class'=>'form-control'])}}
                </div>
